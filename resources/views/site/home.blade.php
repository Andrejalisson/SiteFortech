...
@section('corpo')
        ...
        <div class="main-banner-wrapper">
            <section class="banner-style-one owl-theme owl-carousel">
                <div class="slide slide-one" style="background-image: url(/Site/images/slider/slider-2-1.jpg);">
                    <div class="container">
                        <div class="row">
                ...
                <div class="slide slide-two" style="background-image: url(/Site/images/slider/slider-2-2.jpg);">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6">
                ...
                <div class="slide slide-three" style="background-image: url(/Site/images/slider/slider-2-3.jpg);">
                    <div class="container">
                        ...
                        <div class="content-block my-auto">
                            ...
                            <div class="signle-featured-one">
                                ...
                                <div class="text-block">
                                    ...
                                    <p>Exercitation ullamco laboris nisi ut aliquip ex ea commodo <br> consequat duis aute irure dolor.</p>
                                </div><!-- /.text-block -->
        ...
        <section class="service-style-one home-page-two">
            <div class="container">
                <div class="title-block-style-two text-center ">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-service-one">
                            <div class="image-block">
                                <img src="/Site/images/services/service-1-1.jpg" alt="Awesome Image" />
                    ...
                    <div class="col-lg-4">
                        <div class="single-service-one">
                            <div class="image-block">
                                <img src="/Site/images/services/service-1-2.jpg" alt="Awesome Image" />
                                <div class="overlay-block">
                                    <a class="more-link" href="#"><i class="fa fa-arrows-alt"></i></a>
                                </div><!-- /.overlay-block -->
                            </div><!-- /.image-block -->
                    ...
                    <div class="col-lg-4">
                        <div class="single-service-one">
                            <div class="image-block">
                                <img src="/Site/images/services/service-1-3.jpg" alt="Awesome Image" />
                                <div class="overlay-block">
                                    <a class="more-link" href="#"><i class="fa fa-arrows-alt"></i></a>
                                </div><!-- /.overlay-block -->
                            </div><!-- /.image-block -->
        ...
        <section class="team-style-one">
            <div class="container">
                <div class="title-block text-center">
                    <span class="tag-line">Team</span><!-- /.tag-line -->
                    <h2>Meet Our Team</h2>
                </div><!-- /.title-block -->
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-team-one text-center  wow fadeInUp" data-wow-duration="1300ms" data-wow-delay="0ms">
                            <div class="image-block">
                                <img src="/Site/images/team/team-1-1.jpg" alt="Awesome Image" />
                            </div><!-- /.image-block -->
                            <div class="text-block">
                                <h3>Marcene Jefferds</h3>
                                <p>Squad Leader</p>
                    ...
                    <div class="col-lg-4">
                        <div class="single-team-one text-center  wow fadeInUp" data-wow-duration="1300ms" data-wow-delay="500ms">
                            <div class="image-block">
                                <img src="/Site/images/team/team-1-2.jpg" alt="Awesome Image" />
                            </div><!-- /.image-block -->
                            <div class="text-block">
                                <h3>Sonja Heichel</h3>
                                <p>Squad Leader</p>
                    ...
                    <div class="col-lg-4">
                        <div class="single-team-one text-center  wow fadeInUp" data-wow-duration="1300ms" data-wow-delay="1000ms">
                            <div class="image-block">
                                <img src="/Site/images/team/team-1-3.jpg" alt="Awesome Image" />
                            </div><!-- /.image-block -->
                            <div class="text-block">
                                <h3>Floretta Zorman</h3>
                                <p>Squad Leader</p>
                                <div class="social-block">
                                    <a href="#"><i class="fa fa-facebook-f"></i></a>
                ...
                <div class="row high-gutter">
                    <div class="col-xl-6 col-lg-12">
                        <div class="single-blog-style-one">
                            <div class="image-block">
                                <img src="/Site/images/blog/blog-1-1.jpg" alt="awesome image">
                                <div class="overlay-block">
                                    <a class="more-link" href="#"><i class="fa fa-arrows-alt"></i></a>
                                </div><!-- /.overlay-block -->
                            </div><!-- /.image-block -->
                        ...
                        <div class="row high-gutter col1-blog-wrapper">
                            <div class="col-xl-12 col-lg-12">
                                <div class="single-blog-style-two clearfix">
                                    <div class="image-block">
                                        <img src="/Site/images/blog/blog-2-1.jpg" alt="awesome image">
                                        <div class="overlay-block">
                                            <a class="more-link" href="#"><i class="fa fa-arrows-alt"></i></a>
                                        </div><!-- /.overlay-block -->
                                    </div><!-- /.image-block -->
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="single-blog-style-two clearfix">
                                    <div class="image-block">
                                        <img src="/Site/images/blog/blog-2-2.jpg" alt="awesome image">
                                        <div class="overlay-block">
                                            <a class="more-link" href="#"><i class="fa fa-arrows-alt"></i></a>
                                        </div><!-- /.overlay-block -->
                                    </div><!-- /.image-block -->
        ...
        <section class="brands-area-one home-two">
            <div class="container">
                <div class="brands-carousel-one owl-carousel owl-theme">
                    <div class="item">
                        <img src="/Site/images/brands/brands-2-1.png" alt="awesome image">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="/Site/images/brands/brands-2-2.png" alt="awesome image">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="/Site/images/brands/brands-2-3.png" alt="awesome image">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="/Site/images/brands/brands-2-4.png" alt="awesome image">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="/Site/images/brands/brands-2-5.png" alt="awesome image">
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="/Site/images/brands/brands-2-1.png" alt="awesome image">
                    </div><!-- /.item -->
